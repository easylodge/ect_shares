...
describe EctShares::Share do
  ...
  describe ".address" do
    ...
    it "does not contain extra trailing commas" do
      subject.address_line_4 = nil
      subject.address_line_5 = ''
      expected_address = [subject.address_line_1, subject.address_line_2, subject.address_line_3].join(", ")
      expect(subject.address).to eq(expected_address)
    end
  end
end
